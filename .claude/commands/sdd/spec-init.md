Initialize a new specification with a detailed project description.
...
## Execution Steps
1. **Load Steering Context**: Read entire `.sdd/steering/` directory (all files present) to apply project-wide rules and integrations before initialization
