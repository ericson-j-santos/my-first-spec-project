...
<instructions>
## Core Task
Execute implementation tasks using Test-Driven Development.

Parse arguments from: $ARGUMENTS
- First token = feature name
- Remaining tokens = optional task numbers (e.g., "1.1" or "1,2,3")
...
- Use **Bash** to run tests and validate
...
- `/sdd:spec-impl <feature> 1.1` - Single task
- `/sdd:spec-impl <feature> 1,2,3` - Multiple tasks

**Execute all pending**:
- `/sdd:spec-impl <feature>` - All unchecked tasks
